"""Sampling script for ViT Regression Baseline"""
import os
import sys
import torch
import numpy as np
...
def main():
    parser = argparse.ArgumentParser(description='ViT Regression Sampling')
    parser.add_argument('--config', type=str, default='baselines/vit_reg/config_vit_reg.yaml')
    parser.add_argument('--checkpoint', type=str, required=True)
    parser.add_argument('--num_samples', type=int, default=None)
    parser.add_argument('--max_batches', type=int, default=None)
    parser.add_argument('--output_dir', type=str, default='baselines/vit_reg/samples')
    ...
    config_for_model['model'] = dict(config['model'])
    config_for_model['model']['use_pretrained'] = False
    model = ViTRegression(config_for_model).to(device)
