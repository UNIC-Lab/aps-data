"""Sampling script for Adv-MLP Baseline"""
import os
import sys
import torch
import numpy as np
...
def main():
    parser = argparse.ArgumentParser(description='Adv-MLP Sampling')
    parser.add_argument('--config', type=str, default='baselines/adv_mlp/config_adv_mlp.yaml')
    parser.add_argument('--checkpoint', type=str, required=True)
    parser.add_argument('--num_samples', type=int, default=None)
    parser.add_argument('--max_batches', type=int, default=None)
    parser.add_argument('--output_dir', type=str, default='baselines/adv_mlp/samples')
    ...
    model.generator.load_state_dict(checkpoint['g_state_dict'])
