"""Sampling script for ResNet-MLP Baseline"""
import os
import sys
import torch
import numpy as np
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='baselines/resnet_mlp/samples')
    ...
    print(f"ResNet-MLP | MAE={metrics['MAE']:.6f}, PSNR={metrics['PSNR']:.2f}, CosSim={metrics['Cosine_Similarity']:.4f}")
